...
/// Published crates in this workspace (scripts/icc-gen is `publish = false`).
const CRATES: &[&str] = &["zenpixels", "zenpixels-convert"];
    ...
    for package in CRATES {
        ...
        doc.push_str(&format!(
            "# {package} public API surface\n\
             # Generated by zenpixels/tests/public_api_doc.rs via `cargo public-api --simplified`\n\
